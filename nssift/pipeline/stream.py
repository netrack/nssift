...
class Stream(object):
    ...
    The derived classes will implements the particular
    processing of the RDDs."""
    ...
    def launch(self, sc, rdd, params):
        """Launch the stream processing of the optionally
        specified RDD.

        This method should be overridden in th derived classes
